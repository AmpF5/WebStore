...
namespace WebStore.Models
{
    public class ShoppingCart
    {
        ...
        public void AddToCart(Keyboard keyboard, int amount)
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(
                s => s.Keyboard.KeyboardId == keyboard.KeyboardId && s.ShoppingCartId == ShoppingCartId);
        ...
        public int RemoveFromCart(Keyboard keyboard)
        {
            var shoppingCartItem = _appDbContext.ShoppingCartItems.SingleOrDefault(
                s => s.Keyboard.KeyboardId == keyboard.KeyboardId&& s.ShoppingCartId == ShoppingCartId);
        ...
        public decimal GetShoppingCartTotal()
        {
            var total = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId)
                .Select(c => c.Keyboard.Price * c.Amount).Sum();
